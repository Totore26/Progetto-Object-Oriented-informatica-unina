...
public class ProfiloImpiegatoGUI extends JDialog {
    ...
    public ProfiloImpiegatoGUI(String matricolaSelezionata, Controller controller, JFrame framePadre) {
        ...
        JTextField sessoField = new JTextField();
        ...
        JTextField tipoImpiegatoField = new JTextField();
        ...
        JTextField dataAssunzioneChooser = new JFormattedTextField();
        ...
        dirigenteCheckBox.setSelected(dirigenteSelezionato);
        ...
        JTable tabellaStorico = new JTable(tabellaStoricoModel);
